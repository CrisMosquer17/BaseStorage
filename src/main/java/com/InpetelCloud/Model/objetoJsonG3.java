...
public class objetoJsonG3 {
	...
	public objetoJsonG3(String meter, String idProfile, String nameFile, ArrayList<modelRegister> register, ArrayList<objetoJsonG3> g3) {
		super();
		this.meter = meter;
	...
	public String toString() {
		return "objetoJsonG3 [meter=" + meter + ", idProfile=" + idProfile + ", nameFile=" + nameFile + ", register=" + register + ", g3=" + g3
				+ "]";
	}
